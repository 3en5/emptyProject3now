...
| 📥 **קליטה חכמה** | **זורקים קובץ למקום אחד** — המערכת מזהה לבד גוף/סוג/שנה/מועד חידוש **ומתייקת אוטומטית** לסלוט המתאים; המשתמש רק מפקח ומאשר. חברה שלא ברשימה? יצירת גוף חדש בלחיצה, עם שם וסוג ממולאים מהזיהוי |

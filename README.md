...
| ✅ **משימות שנתיות** | תב"ר של דוחות להגשה (מס הכנסה, מע"מ, ביטוח לאומי...) — **מסומנות אוטומטית** כשמתקבל מסמך תואם (למשל "טופס 106") |

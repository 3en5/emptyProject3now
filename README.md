...
| 📥 **קליטה חכמה** | **זורקים קובץ למקום אחד** — המערכת מזהה לבד גוף/סוג/שנה/מועד **ומתייקת אוטומטית**; המשתמש רק מפקח. זיהוי היברידי: כללים מקומיים + **GPT (ראייה)** לסרוקים ולעברית. חברה שלא ברשימה? יצירת גוף בלחיצה. קובץ כפול? מזוהה ולא מועלה שוב |
